...
public class DefaultResource extends WrappedIndividualImpl implements Resource {
    ...
    public Collection<? extends Object> getSkills() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SKILLS, Object.class);
    }
    ...
    public void addSkills(Object newSkills) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SKILLS, newSkills);
    }

    public void removeSkills(Object oldSkills) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SKILLS, oldSkills);
    }
