 ...
 */
public class HardwareSimulationLayout2 implements HardwareInterface {

    Layout2 myLayout;

    @Override
    public void initHardware(TransportAgent myTA) {
        myLayout = new Layout2();
    ...
    private static class Simulate extends TickerBehaviour {
        ...
        public Simulate(Agent a, long period, Layout2 myLayout) {
            super(a, period);
